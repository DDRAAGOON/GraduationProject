...
class AppLocalizations {
  ...
  String get seeAll =>
      userTr('common.seeAll', fallbackEn: 'See All', fallbackAr: 'عرض الكل');
  ...
  String get employee => userTr(
    'profile.employee',
    fallbackEn: 'Employee',
    fallbackAr: 'الموظفون',
  );
  String get industry =>
      userTr('profile.industry', fallbackEn: 'Industry', fallbackAr: 'القطاع');
  ...
  // ── Tradesman Home ──────────────────────────────────────────────────────────
  String get findNextJob => userTr(
    'tradesman.findNextJob',
    fallbackEn: 'Find your next job',
    fallbackAr: 'ابحث عن عملك التالي',
  );
  String get skillTodayHint => userTr(
    'tradesman.skillTodayHint',
    fallbackEn: 'What is your skill today?',
    fallbackAr: 'ما هي مهارتك اليوم؟',
  );
  String get featuredOpportunities => userTr(
    'tradesman.featuredOpportunities',
    fallbackEn: 'Featured Opportunities',
    fallbackAr: 'فرص عمل مميزة',
  );
  String get featuredOpportunitiesSub => userTr(
    'tradesman.featuredOpportunitiesSub',
    fallbackEn:
        'Discover the latest tasks and jobs available for you as a professional tradesman.',
    fallbackAr: 'اكتشف أحدث المهام والوظائف المتاحة لك كصنايعي محترف.',
  );
  String get suggestedJobs => userTr(
    'tradesman.suggestedJobs',
    fallbackEn: 'Available Jobs Today',
    fallbackAr: 'الوظائف المتاحة اليوم',
  );
  String get noJobsAvailable => userTr(
    'tradesman.noJobsAvailable',
    fallbackEn: 'No new jobs published on this day yet',
    fallbackAr: 'لا توجد وظائف جديدة تم نشرها في هذا اليوم بعد',
  );

  // ── Translation Helpers ─────────────────────────────────────────────────────
  String translateLocation(String loc) =>
      userTr('location.$loc', fallbackEn: loc, fallbackAr: loc);
  String translateSalary(String s) =>
      userTr('salary.$s', fallbackEn: s, fallbackAr: s);
  String translateJobTitle(String t) =>
      userTr('jobTitle.$t', fallbackEn: t, fallbackAr: t);
  String translateCompanyName(String c) =>
      userTr('companyName.$c', fallbackEn: c, fallbackAr: c);
  String translateJobType(String type) =>
      userTr('jobType.$type', fallbackEn: type, fallbackAr: type);
  String translateCategory(String cat) =>
      userTr('category.$cat', fallbackEn: cat, fallbackAr: cat);

  String get positions => tr(en: 'Positions', ar: 'العدد المطلوب');
  String get positionsHint =>
      tr(en: 'e.g. 1', ar: 'حدد عدد المقاعد المتاحة لهذا المنصب');
  String get whenClose =>
      tr(en: 'When will it close?', ar: 'متى سيغلق باب التقديم؟');
  String get basicInfoLabel =>
      tr(en: 'Basic Information', ar: 'معلومات أساسية');
  String get updateIdentity => tr(
    en: 'Update your company identity and contact details.',
    ar: 'قم بتحديث هوية شركتك وتفاصيل الاتصال.',
  );
  ...
  String get departmentHint => tr(
    en: 'e.g. Engineering, Marketing...',
    ar: 'اكتب فئة الوظيفة المناسبة... مثال: هندسة، تسويق',
  );
  ...
  String get invalidCredentials => tr(
    en: 'Invalid email or password.',
    ar: 'البريد الإلكتروني أو كلمة المرور غير صحيحة',
  );
  String get connectionError =>
      tr(en: 'Server connection error.', ar: 'حدث خطأ في الاتصال بالخادم');
  String get timeoutError => tr(
    en: 'Connection timeout. Check your internet.',
    ar: 'فشل الاتصال بالخادم، تحقق من الإنترنت',
  );
  String get googleSignInFailed =>
      tr(en: 'Google Sign-In failed', ar: 'فشل تسجيل الدخول باستخدام جوجل');
  String get commercialRegisterLabel =>
      tr(en: 'Commercial Register', ar: 'السجل التجاري');
  String get enterCommercialRegisterHint =>
      tr(en: 'Enter Commercial Register', ar: 'أدخل السجل التجاري');
  String get nationalNumberOfficialLabel =>
      tr(en: 'National Number of Official', ar: 'الرقم القومي للمسؤول');
  String get enterNationalNumberHint =>
      tr(en: 'Enter National Number', ar: 'أدخل الرقم القومي للمسؤول');
  ...
  String get registrationFailed => tr(
    en: 'Registration failed. Please try again.',
    ar: 'فشل التسجيل، حاول مرة أخرى.',
  );
  String get emailAlreadyRegistered => tr(
    en: 'Email already registered. Try a different one.',
    ar: 'البريد الإلكتروني مستخدم بالفعل، جرّب بريداً آخر.',
  );
  ...
  String get unknownRoute => userTr(
    ...
    fallbackAr: 'المشار غير معروف',
  );
  String get welcomeBackCompany =>
      tr(en: 'Welcome Back Company', ar: 'مرحباً بعودتكم');
  ...
  String get createCompanyAccount =>
      tr(en: 'Create Company Account', ar: 'إنشاء حساب شركة');
  String get welcomeBack => tr(en: 'Welcome Back', ar: 'مرحباً بعودتك');
  String get signInToManage => tr(
    en: 'Sign in with your company account to manage jobs and candidates.',
    ar: 'سجل الدخول بحساب شركتك لإدارة الوظائف والمرشحين.',
  );
}
