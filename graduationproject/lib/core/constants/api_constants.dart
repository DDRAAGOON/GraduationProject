class ApiConstants {
  ...
  static const String userDeletionStatus =
      '$apiPrefix/users/me/deletion-status';
  static String userById(String id) => '$apiPrefix/users/$id';

  // Jobs
  static const String jobs = '$apiPrefix/jobs';
  static String companyJobs(String companyId) =>
      '$apiPrefix/jobs/company/$companyId';
  ...
  static const String oldMyApplications =
      '$apiPrefix/applications/my-applications';
  static String jobApplications(String jobId) =>
      '$apiPrefix/applications/job/$jobId';
  static String applicationById(String id) => '$apiPrefix/applications/$id';
  static String applicationStatus(String id) =>
      '$apiPrefix/applications/$id/status';
  static String applicationCheckStatus(String jobId) =>
      '$apiPrefix/applications/status/$jobId';
  ...
  static String updateCompanyStatus(String id) =>
      '$apiPrefix/companies/$id/status';
  static const String myCompanyProfile = '$apiPrefix/companies/my/profile';
  static const String myCompanyDashboard =
      '$apiPrefix/companies/my/dashboard-summary';
  static String companyStats(String id) =>
      '$apiPrefix/companies/$id/statistics';

  // Notifications
  static const String notifications = '$apiPrefix/notifications';
  static const String subscribeNotifications =
      '$apiPrefix/notifications/subscribe';
  ...
  static String chatUserInfo(String userId) =>
      '$apiPrefix/chat/user-info/$userId';
  ...
  static String aiHistory(String userId) =>
      '$apiPrefix/ai-chatbot/history/$userId';
  static String aiChatbotHistory(String userId) =>
      '$apiPrefix/ai-chatbot/history/$userId';
  ...
  static String entityImages(String type, String id) =>
      '$apiPrefix/images/entity/$type/$id';
  static String userProfileImage(String userId) =>
      '$apiPrefix/images/profile/$userId';
  ...
  static String pushSubscriptions(String userId) =>
      '$apiPrefix/push/subscriptions/$userId';
  static const String pushVapidKey = '$apiPrefix/push/vapid-key';

  // Support & Dashboard
  static const String supportHelpCategories =
      '$apiPrefix/support/help/categories';
  static const String supportHelpArticles = '$apiPrefix/support/help/articles';
  static String supportHelpArticleById(String id) =>
      '$apiPrefix/support/help/articles/$id';
  ...
  static const String applicantsSummary =
      '$apiPrefix/dashboard/applicants-summary';

  // Favorites
  static String toggleFavorite(String jobId) =>
      '$apiPrefix/favorites/toggle/$jobId';
  static const String favorites = '$apiPrefix/favorites';

  // Ratings
  static const String ratings = '$apiPrefix/ratings';
  static String companyRatings(String companyId) =>
      '$apiPrefix/ratings/company/$companyId';
  ...
  static String companyGivenRatings(String companyId) =>
      '$apiPrefix/ratings/company/$companyId/given';
  static String userGivenRatings(String userId) =>
      '$apiPrefix/ratings/user/$userId/given';
