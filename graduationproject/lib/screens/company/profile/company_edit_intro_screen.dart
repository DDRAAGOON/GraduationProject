...
class CompanyEditIntroArgs {
  const CompanyEditIntroArgs({required this.english, required this.arabic});
...
class _CompanyEditIntroScreenState extends State<CompanyEditIntroScreen>
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            t.tr(
              en: 'Saved. JSON files: $dir',
              ar: 'تم الحفظ. ملفات JSON: $dir',
            ),
          ),
        ),
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(t.tr(en: 'Failed to save: $e', ar: 'تعذّر الحفظ: $e')),
        ),
      );
    }
  }
  ...
  Future<void> _copyJson(bool english) async {
    final t = AppLocalizations.of(context);
    final r = IntroPolishResult(
      english: _en.text.trim(),
      arabic: _ar.text.trim(),
    );
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          english
              ? t.tr(en: 'English JSON copied', ar: 'تم نسخ English JSON')
              : t.tr(en: 'Arabic JSON copied', ar: 'تم نسخ Arabic JSON'),
        ),
      ),
    );
  }
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelText: t.tr(
                        en: 'About / Intro (Arabic)',
                        ar: 'نبذة عني / التعريف',
                      ),
                      hintText: t.tr(
                        en: 'Write your Arabic intro...',
                        ar: 'اكتب النسخة العربية لملفك التعريفي…',
                      ),
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      alignLabelWithHint: true,
                      labelText: t.tr(
                        en: 'About / Intro (primary)',
                        ar: 'نبذة عني (لغة رئيسية)',
                      ),
                      hintText: t.tr(
                        en: 'Write your English intro — primary profile language…',
                        ar: 'اكتب النسخة الانجليزية لملفك التعريفي...',
                      ),
                      border: const OutlineInputBorder(),
                    ),
                  ),
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        label: Text(
                          _polishing
                              ? t.tr(en: 'Polishing...', ar: 'جاري التحسين…')
                              : t.tr(en: 'Polish', ar: 'تحسين'),
                        ),
                      ),
                    ),
                    ...
                    IconButton(
                      tooltip: t.tr(
                        en: 'Copy English JSON',
                        ar: 'نسخ الإصدار الإنجليزي JSON',
                      ),
