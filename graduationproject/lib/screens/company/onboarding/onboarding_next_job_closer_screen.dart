                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          Text(
                            t.tr(
                              en: 'Manage Candidate Pipeline',
                              ar: 'إدارة خط توظيف المرشحين',
                            ),
                          ...
                          Text(
                            t.tr(
                              en: 'Move applicants through review, shortlist, and hire.',
                              ar: 'انقل المتقدمين عبر المراجعة والقائمة المختصرة والتوظيف.',
                            ),
                            textAlign: TextAlign.center,
                            style: TextStyle(
                        ...
                        children: [
                          Row(
                            children: List.generate(
                              3,
                              (index) => _buildIndicator(isActive: index == 1),
                            ),
                          ),
                          _buildNextButton(() {
                            Navigator.of(context).pushNamed(AppRoutes.companyOnboardingFutureStarts);
                          }, t),
                        ],
                      ),
                    ),
