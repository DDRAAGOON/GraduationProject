...
class _SignUpSeeker extends State<SignUpSeeker> {
  ...
  final List<String> _years = List.generate(
    70,
    (i) => (DateTime.now().year - 10 - i).toString(),
  );
  ...
  void _addSocialLink() {
    if (_socialController.text.isNotEmpty) {
      setState(() {
        _socialLinksList.add({
          "platform": _selectedPlatform,
          "url": _socialController.text.trim(),
        });
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        RecruitmentSyncStore.instance.updateUserProfile(
          ...
          title: _expJobTitleController.text.isNotEmpty
              ? _expJobTitleController.text
              : "User",
            ...
            child: Column(
              ...
              children: [
                ...
                _buildTextField(
                  ...
                  t.tr(en: "Education Institution", ar: "المؤسسة التعليمية"),
                  ...
                  (entry) => Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "${entry.value['institution']} - ${entry.value['degree']} (${entry.value['duration']})",
                            style: const TextStyle(
                              color: Colors.black87,
                              fontSize: 12,
                            ),
                ...
                const SizedBox(height: 35),
                Text(
                  t.tr(en: "Professional Details", ar: "تفاصيل مهنية"),
                  style: const TextStyle(
                    color: Colors.black87,
                    fontSize: 16,
                    fontWeight: FontWeight.w600,
                ...
                ..._experiencesList.asMap().entries.map(
                  (entry) => Container(
                    margin: const EdgeInsets.only(top: 10),
                    padding: const EdgeInsets.all(12),
                    decoration: BoxDecoration(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "${entry.value['title']} (${entry.value['duration']})",
                            style: const TextStyle(
                              color: Colors.black87,
                              fontSize: 12,
                            ),
                        ...
                        IconButton(
                          ...
                          onPressed: () => setState(
                            () => _experiencesList.removeAt(entry.key),
                          ),
                        ),
                      ],
                    ),
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText: t.tr(en: "Link", ar: "الرابط"),
                          hintStyle: const TextStyle(
                            color: Colors.black26,
                            fontSize: 12,
                          ),
                ...
                const SizedBox(height: 10),
                ..._socialLinksList.asMap().entries.map(
                  (entry) => Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "${entry.value['platform']}: ${entry.value['url']}",
                            style: const TextStyle(
                              color: Colors.black87,
                              fontSize: 11,
                            ),
                        ...
                        IconButton(
                          ...
                          onPressed: () => setState(
                            () => _socialLinksList.removeAt(entry.key),
                          ),
                        ),
                      ],
                    ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(15),
          border: Border.all(
            color: isSelected ? const Color(0xFF49769F) : Colors.grey.shade300,
            width: 1.5,
          ),
