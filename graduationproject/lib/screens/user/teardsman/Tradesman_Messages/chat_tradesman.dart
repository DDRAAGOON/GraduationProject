...
class ChatTradesman extends StatefulWidget {
  ...
  const ChatTradesman({super.key, required this.name, required this.image});
...
class _ChatTradesmanState extends State<ChatTradesman> {
  ...
  void _sendMessage() {
    ...
    setState(() {
      _messages.add({"isMe": true, "text": text, "time": time});
