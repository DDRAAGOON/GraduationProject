            ...
            children: [
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: CircularProgressIndicator(
                                  ...
                                  strokeWidth: 12,
                                  backgroundColor: isDark ? Colors.black.withOpacity(0.1) : const Color(0xFFF0F2F5),
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () => Navigator.of(context).pushNamed(AppRoutes.userAllApplications), 
                    child: Text(isAr ? 'عرض الكل' : 'See All', style: const TextStyle(color: Color(0xFF213E75)))
                  ),
                ],
              ),
              const SizedBox(height: 16),
