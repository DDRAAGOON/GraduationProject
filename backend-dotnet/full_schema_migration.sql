...
ELSE
BEGIN
    PRINT 'TABLE [Applications] already exists – no new columns to add.';
END
GO
...
ELSE
BEGIN
    PRINT 'TABLE [Messages] already exists – no new columns to add.';
END
GO
...
ELSE
BEGIN
    PRINT 'TABLE [Notifications] already exists – no new columns to add.';
END
GO
